...
export const {resetGame,updateDiceNo,announceWinner,updatePlayerChance,updateFireworks,disableTouch,unfreezeDice,enableCellSelection,enablePileSelection,updatePlayerPieceValue}=gameSlice.actions;
